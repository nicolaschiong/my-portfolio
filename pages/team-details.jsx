          ...
          <div className="row gap-100 align-items-center">
            ...
            <div className="col-lg-6">
              <div className="team-profile-content wow fadeInRight delay-0-2s">
                ...
                <p>
                  On the other hand, we denounce with righteous indignation dislike men who are so
                  ...
                  equal blame belongs those who fail in their duty through weakness of wil same
                </p>
                ...
                <div className="contact-info-item">
                  ...
                  <div className="content">
                    ...
                    <span className="text">55 Main Street, Melbourne, Australia</span>
                  </div>
                </div>
                <div className="contact-info-item">
                  <div className="icon">
                  ...
                  <div className="content">
                    ...
                    <span className="text">
                      <a href="mailto:njcolaschiong@gmail.com">njcolaschiong@gmail.com</a>
                    </span>
                  </div>
                </div>
                <div className="contact-info-item">
          ...
          <div className="row gap-80">
            ...
            <div className="col-lg-6">
              <div className="skill-content wow fadeInUp delay-0-4s">
                <p>
                  Similique sunin culpa qui officia deserunt mollitia animi est laborum et dolorum
                  fuga. Et harum quidem rerum facilis esty expedita distinctioam nobis est eligendi
                  optio cumquey
                </p>
                <TeamSkills />
              </div>
