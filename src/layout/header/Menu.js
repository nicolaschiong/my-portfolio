      ...
      <li className="dropdown">
        ...
        <ul style={activeLi("home")}>
          <li className="dropdown">
            ...
            <div className="dropdown-btn" onClick={() => multiMenuSet("multiPage")}>
              <span className="far fa-plus" />
            </div>
          </li>
          <li className="dropdown">
            ...
            <div className="dropdown-btn" onClick={() => multiMenuSet("OnePage")}>
              <span className="far fa-plus" />
            </div>
          </li>
        </ul>
      ...
      <li className="dropdown">
        ...
        <ul style={activeLi("pages")}>
          ...
          <li className="dropdown">
            ...
            <div className="dropdown-btn" onClick={() => multiMenuSet("Products")}>
              <span className="far fa-plus" />
            </div>
          </li>
          <li className="dropdown">
